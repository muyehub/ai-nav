...
const navItems = ref([
  ...
  },
  {
    ...
    description: "由 Supabase 开发的 AI 驱动工具",
  ...
  },
  {
    id: 54,
    title: "Vela OS",
    description: "面向风险投资领域的 AI 原生操作系统",
    icon: "fas fa-rocket",
    bgColor: "#6366F1",
    link: "https://vela.com",
    category: "office"
  },
  {
    id: 55,
    title: "Oopsie",
    description: "为移动应用开发者提供的 AI 驱动调试工具",
    icon: "fas fa-bug",
    bgColor: "#F43F5E",
    link: "https://oopsie.ai",
    category: "dev"
  },
  {
    id: 56,
    title: "ACE Studio",
    description: "为专业人士提供的 AI 声乐合成工作站",
    icon: "fas fa-music",
    bgColor: "#8B5CF6",
    link: "https://ace-studio.ai",
    category: "audio"
  },
  {
    id: 57,
    title: "Coval Dev",
    description: "通过自动化模拟和评估，帮助开发者快速构建可靠语音和聊天 AI 代理的平台",
    icon: "fas fa-microchip",
    bgColor: "#2DD4BF",
    link: "https://coval.dev",
    category: "dev"
  },
  {
    id: 58,
    title: "Stackfix",
    description: "通过简单的比较工具帮助用户快速选择软件的智能平台",
    icon: "fas fa-layer-group",
    bgColor: "#0EA5E9",
    link: "https://stackfix.com",
    category: "dev"
  },
  {
    id: 59,
    title: "Magic Dev",
    description: "通过自动化人工智能研究和代码生成",
    icon: "fas fa-wand-magic-sparkles",
    bgColor: "#A855F7",
    link: "https://magic.dev",
    category: "dev"
  },
  {
    id: 60,
    title: "Poolside AI",
    description: "专注于现代软件工程挑战的 AI 基础模型平台",
    icon: "fas fa-laptop-code",
    bgColor: "#EC4899",
  ...
  },
  {
    id: 61,
    title: "Factory",
    description: "代码智能体 Coding agent 产品",
  ...
  },
  {
    id: 62,
    title: "Hebbia",
    description: "专注于为知识工作提供解决方案的人工智能平台",
    icon: "fas fa-brain",
    bgColor: "#4A5568",
  ...
  },
  {
    id: 63,
    title: "Websim",
    description: "让你把原型做得非常有趣，甚至是疯狂创意",
  ...
  },
  {
    id: 64,
    title: "Momentic",
    description: "先进的人工智能测试工具，为软件测试过程提供自动化解决方案",
    icon: "fas fa-vial",
    bgColor: "#805AD5",
  ...
  },
  {
    id: 66,
    title: "Praktika",
    description: "模拟真实对话，帮助用户克服语言障碍",
    icon: "fas fa-comments",
    bgColor: "#4299E1",
    link: "https://praktika.ai",
    category: "chat"
  },
  {
    id: 67,
    title: "Enfabrica",
    description: "用于人工智能数据中心的芯片开发商",
    icon: "fas fa-microchip",
    bgColor: "#667EEA",
    link: "https://enfabrica.ai",
    category: "dev"
  },
  {
    id: 68,
    title: "Tezza",
    description: "面向创作者和社交媒体用户的照片和视频编辑应用程序",
    icon: "fas fa-camera",
    bgColor: "#F56565",
    link: "https://tezza.ai",
    category: "image"
  ...
  },
  {
    id: 70,
    title: "BforeAI",
    description: "通过预测技术来主动识别和阻止网络攻击",
  ...
  },
  {
    id: 71,
    title: "心影随形",
    description: "AI游戏陪玩，AI虚拟陪玩助手",
    icon: "fas fa-gamepad",
    bgColor: "#ED64A6",
    link: "https://lynksoul.ai",
    category: "chat"
  },
  {
    id: 72,
    title: "反曲",
    description: "AI原生数据编排平台",
    icon: "fas fa-database",
    bgColor: "#4FD1C5",
    link: "https://recurve.ai",
    category: "dev"
  },
  {
    id: 73,
    title: "Galbot",
    description: "银河通用机器人，致力于通过仿真技术实现机器人的自主学习",
    icon: "fas fa-robot",
    bgColor: "#9F7AEA",
    link: "https://galbot.ai",
    category: "dev"
  }
])
...
onMounted(() => {
  ...
  try {
    ...
    (window.adsbygoogle = window.adsbygoogle || []).push({});  // 为第二个广告位添加
  } catch (error) {
